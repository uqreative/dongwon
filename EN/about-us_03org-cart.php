...
<div class="container-fluid sub-menu">
    <div class="container">
        <ul class="nav nav-pills nav-fill justify-content-start justify-content-lg-center flex-nowrap">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="./about-us_03org-cart.php">조직도</a>
            </li>
            <li class="nav-item">
...
<main class="about-orgcart">
    <section class="sub-menu_tittle">

        <h4 data-aos="fade-up" data-aos-delay="300" data-aos-easing="ease-in-out" data-aos-duration="700" >조직도
        </h4>
        <h3 data-aos="fade-up" data-aos-delay="450" data-aos-easing="ease-in-out" data-aos-duration="700" >Organization Chart</h3>
