...
<main class="inquiry-from">
    <section class="sub-menu_tittle">
        ...
        <h4 data-aos="fade-up" data-aos-delay="300" data-aos-easing="ease-in-out" data-aos-duration="700"
            data-aos-anchor-placement="top-bottom">태양광발전 바로알기
        </h4>
        <h3 data-aos="fade-up" data-aos-delay="450" data-aos-easing="ease-in-out" data-aos-duration="700"
            data-aos-anchor-placement="top-bottom">Understanding solar power generation</h3>
    ...
    <section class="inquiry__list">
        ...
        <div class="container mt-3">
            <img src="./images/solar-power.jpg" class="img-fluid" alt="">
        </div>
        ...
        <!-- Inquiry list table -->
            <div class="container mt-0 mt-lg-5">
                ...
                <div class="d-flex justify-content-lg-between align-items-baseline align-items-md-center my-5">
                    <form action="">
