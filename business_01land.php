...
<div class="container-fluid sub-menu">
    <div class="container">
        <ul class="nav nav-pills nav-fill justify-content-start justify-content-lg-center flex-nowrap">
            <li class="nav-item">
                <a class="nav-link active" href="./business_01land.php">토지</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="./business_02building.php">건물 태양광</a>
            </li>
        </ul>
    </div>
</div>
