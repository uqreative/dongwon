<header>
  <nav id="navbar" class="navbar navbar-expand-lg shadow fixed-top bg-nav-transparant">
    <div class="container-fluid justify-content-between px-3 px-lg-5">
      ...
      <button class="navbar-toggler focus-ring focus-ring-light my-2 mx-2" type="button" data-bs-toggle="collapse"
        data-bs-target="#mobileNavbarToggler" aria-controls="mobileNavbarToggler" aria-expanded="false"
        aria-label="Toggle navigation">
        <span class="navbar-toggler-icon"></span>
      </button>

      <div class="collapse navbar-collapse px-3 px-lg-0 pb-4 pb-lg-0" id="mobileNavbarToggler">
        ...
        <div
          class="d-flex flex-row justify-content-between justify-content-lg-start align-items-lg-center mt-4 mt-lg-0">
          <div class="dropdown select-lang">
            <a id="btn-lang" class="btn btn-outline-light text-white btn-lang-transparant dropdown-toggle" href="#"
              role="button" id="dropdownMenuLink" data-bs-toggle="dropdown" aria-expanded="false">
              <img src="./images/icon-world_select-lang.svg" id="icon-lang-white" class="d-inline-block " width="14"
                height="14" alt="">
              <img src="./images/icon-world_select-lang-black.svg" id="icon-lang-black" class="d-none" width="14"
                height="14" alt=""> KOR
            </a>
          ...
          <a href="#" id="btn-manager" class="btn btn-outline-light d-flex align-items-center text-white">
  ...
  <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasMenu" aria-labelledby="offcanvasRightLabel">
    <div class="offcanvas-body">
      ...
      <ul class="nav flex-column mt-4">
        ...
        <li class="nav-item">
          <a class="nav-link" href="./business_01product.php">제품소개</a>
        </li>
        <li class="nav-item">
