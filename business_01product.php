...
<main class="business-product">
    <section class="sub-menu_tittle">
        ...
        <h4 data-aos="fade-up" data-aos-delay="300" data-aos-easing="ease-in-out" data-aos-duration="700"
            data-aos-anchor-placement="top-bottom">제품소개
        </h4>
        <h3 data-aos="fade-up" data-aos-delay="450" data-aos-easing="ease-in-out" data-aos-duration="700"
            data-aos-anchor-placement="top-bottom">Introduction of item</h3>

    </section>

    <section class="product__list">
    
        <div class="container"   data-aos="fade-up" data-aos-delay="100" data-aos-easing="ease-in-out" data-aos-duration="400" data-aos-anchor-placement="top-center">
            <div class="row row-cols-1 row-cols-md-4 g-4">
                <div class="col">
                    <a href="./business_01product_overview.php">
